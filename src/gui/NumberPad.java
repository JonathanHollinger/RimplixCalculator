...
public class NumberPad extends JPanel
{
  ...
  public NumberPad(ActionListener listener)
  {
    ...
    inputMap.put(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT_PARENTHESIS, KeyEvent.SHIFT_DOWN_MASK), "(");
    inputMap.put(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT_PARENTHESIS, KeyEvent.SHIFT_DOWN_MASK), ")");
    setupLayout();
  }
